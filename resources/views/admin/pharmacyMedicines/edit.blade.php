...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pharmacy-medicines.update", [$medicine->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $medicine->price) }}" step="0.01" required>
                        @if($errors->has('price'))
                            <div class="invalid-feedback">
                                {{ $errors->first('price') }}
                            </div>
...
<script>
    ...
    url: '{{ route('admin.pharmacy-medicines.storeMedia') }}',
    maxFilesize: 5, // MB
